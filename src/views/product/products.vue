<template lang="pug">
  div(:class="$style.product")
    wu-card
      el-form(:model='formValues', :inline="true")
        el-row(:gutter="48")
          el-col(:xs="24", :sm="8", :md="8", :lg="8", :xl="8")
            el-form-item(label='商品名称')
              el-input(v-model='formValues.name', placeholder='请输入商品名称/代码')
          el-col(:xs="24", :sm="8", :md="8", :lg="8", :xl="8")
            el-form-item(label='商品类型')
              el-select(v-model='formValues.type', placeholder='请选择商品类型')
          ...
          template(v-if="showMore")
            el-col(:xs="24", :sm="8", :md="8", :lg="8", :xl="8")
              el-form-item(label='商品分组')
                el-select(v-model='formValues.group', placeholder='请选择商品分组')
                  el-option(label='全部', value='')
            ...
            el-col(:xs="24", :sm="8", :md="8", :lg="8", :xl="8")
              el-form-item(label='价格')
                el-row
                  el-col(:span="11")
                    el-input(v-model='formValues.user')
          ...
          el-col(:xs="24", :sm="8", :md="8", :lg="8", :xl="8")
            el-form-item
              ...
              el-button(@click='handleFormReset') 重置
      ...
      div(v-loading="loading")
        el-table(
          ...
          el-table-column(prop='group', label='商品分组')
            template(slot-scope='scope') {{ scope.row.group | productGroup }}
...
<script>
import { queryProducts } from '@/services/product'
export default {
  name: 'product',
  components: {},
  props: {
